...
class GetDiagnostics200Response(BaseModel):
    ...
    """ # noqa: E501
    config: Dict[str, Any]
    docker_dependent_image_hashes: Optional[Dict[str, Any]] = Field(default=None, alias="docker-dependent-image-hashes")
    ...
    __properties: ClassVar[List[str]] = ["config", "docker-dependent-image-hashes", "docker-dependent-image-hosts", "docker-inspect", "file-tree", "important-endpoints", "info", "logs", "services", "usage", "version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "docker-dependent-image-hashes": obj.get("docker-dependent-image-hashes"),
