...
class ProApi:
    ...
    def delete_pod(
        ...
        local: Annotated[
            Optional[StrictStr],
            Field(description="If true, the pod will be deleted only from the local storage"),
        ] = None,
        x_localstack_state_secret: Annotated[
            Optional[StrictStr],
            Field(description="A secret token for authenticating the request against the platform"),
        ] = None,
    ...
    def list_pods(
        ...
        creator: Annotated[
            Optional[StrictStr],
            Field(description="User ID of the pod creator. Special values like `me` are accepted."),
        ] = None,
        remote_config: Optional[RemoteConfig] = None,
        _request_timeout: Union[
            None,
    ...
    def load_pod(
        self,
        name: Annotated[
            StrictStr, Field(description="The name of the Cloud Pod to be loaded into the runtime")
        ],
        version: Annotated[
            Optional[StrictStr],
            Field(description="The version of the Cloud Pod to be loaded into the runtime"),
        ] = None,
        merge: Annotated[
            Optional[StrictStr], Field(description="Merge strategy to use when loading the pod")
        ] = None,
